...
В ФП у функций сигнатура минималистична, содержащит только необходимые поля, а типы аргументов по сути являются интерфейсами, не требующими их явной реализации.
