...
spoiler: 'Вашему вниманию представляется RRC - легковесная библиотека для загрузки и кэширования данных в React приложениях, которая поддерживает нормализацию, в отличие от React Query и RTK Query, при этом имеет похожий, но очень простой интерфейс. Построена для Zustand/Redux, покрыта тестами, полностью типизирована и написана на Typescript.'
links:
...
Вашему вниманию представляется  [RRC](https://github.com/gentlee/rrc) - легковесная библиотека для загрузки и кэширования данных в React приложениях, которая поддерживает нормализацию, в отличие от  **React Query**  и  **RTK Query**, при этом имеет похожий, но очень простой интерфейс. Построена для Zustand/Redux, покрыта тестами, полностью типизирована и написана на Typescript.
...
Другие примеры использования можно найти в  [документации](https://github.com/gentlee/rrc).
